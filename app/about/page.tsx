  ...
  const features = [
    {
      ...
      description: "Engage with real-time coding challenges, interactive tutorials, and instant feedback on your code.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: Users,
      title: "Peer Learning",
      description: "Connect with fellow learners, participate in code reviews, and learn through pair programming sessions.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Rocket,
      title: "Project-Based",
      description: "Build real-world projects from day one, with industry-standard tools and best practices.",
      gradient: "from-purple-500 to-indigo-500"
    },
    {
      icon: Lightbulb,
      title: "Smart Practice",
      description: "Get personalized learning paths and practice exercises based on your skill level and goals.",
      gradient: "from-orange-500 to-red-500"
    }
  ];

  const stats = [
    { number: "10K+", label: "Active Learners", icon: Users, color: "text-blue-500" },
    { number: "500+", label: "Coding Challenges", icon: Code2, color: "text-green-500" },
    { number: "50+", label: "Learning Paths", icon: Target, color: "text-purple-500" },
    { number: "24/7", label: "Support", icon: Heart, color: "text-red-500" }
  ];
  ...
  const team = [
    {
      ...
      description: "Engineer with a passion for making coding education accessible.",
      badge: "Founder",
      socials: {
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">
                Discover what makes our platform unique and effective for your learning journey.
              </p>
            </motion.div>
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">
                We believe that everyone should have access to quality coding education. Our mission is to empower developers worldwide with the skills, knowledge, and community support they need to succeed in the tech industry.
              </p>
            </motion.div>
                ...
                <Card className="relative border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2">
                  ...
                  <CardHeader className="relative">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-2xl font-bold text-primary">Community Growth</CardTitle>
                        <p className="text-lg font-semibold text-foreground">Building Together</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="relative">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Our goal is to build a vibrant community of 10,000+ active learners by the end of 2024, 
                      fostering collaboration and knowledge sharing among developers of all levels, regardless of their background or experience.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                ...
                <Card className="relative border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2">
                  ...
                  <CardHeader className="relative">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-2xl font-bold text-primary">Learning Platform</CardTitle>
                        <p className="text-lg font-semibold text-foreground">Innovation First</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="relative">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      We&apos;re developing an AI-powered learning platform with 500+ coding challenges and 
                      50+ structured learning paths to help developers master their skills in an inclusive learning environment.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                ...
                <Card className="relative border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2">
                  ...
                  <CardHeader className="relative">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-2xl font-bold text-primary">Global Reach</CardTitle>
                        <p className="text-lg font-semibold text-foreground">Expanding Horizons</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="relative">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Planning to expand our reach to 50+ countries, making coding education accessible 
                      to developers worldwide through localized content and community support, ensuring quality education for everyone.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                ...
                <Card className="relative border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group hover:-translate-y-2">
                  ...
                  <CardHeader className="relative">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <CardTitle className="text-2xl font-bold text-primary">Career Impact</CardTitle>
                        <p className="text-lg font-semibold text-foreground">Success Stories</p>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="relative">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      Aiming to help 1,000+ developers land their dream jobs in tech through our 
                      comprehensive learning programs and industry partnerships, empowering them with the skills and knowledge to succeed.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">
                Real experiences from our community members who&apos;ve transformed their careers.
              </p>
            </motion.div>
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Badge variant="secondary" className="bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary/90 border-primary/20 dark:border-primary/30 px-6 py-3 text-sm font-semibold">
