      ...
      <div className="container px-4 relative z-10 mx-auto">
        <div className="text-center space-y-4 mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold animate-fade-in">
            What Our <span className="gradient-text bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-600">Community</span> Says
          </h2>
          <p className="text-xl text-muted-foreground animate-fade-in-up">
            Hear from developers who&apos;ve transformed their careers with Codeunia
          </p>
        </div>
